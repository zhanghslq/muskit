package io.github.zhanghslq.muskit.lock.autoconfigure.aspect;
...
import io.github.zhanghslq.muskit.lock.context.FencingTokenContext;
...
public final class DistributedLockAspect implements Ordered {
     ...
     */
    @Around("@annotation(io.github.zhanghslq.muskit.lock.annotation.DistributedLock)"
            + " || @within(io.github.zhanghslq.muskit.lock.annotation.DistributedLock)")

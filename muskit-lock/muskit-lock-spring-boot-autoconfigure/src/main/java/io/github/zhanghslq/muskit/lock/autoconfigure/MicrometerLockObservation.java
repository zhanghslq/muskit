 ...
 * @since 2026-08-20
 */
final class MicrometerLockObservation implements LockObservation {

    static final String ACQUIRE_METRIC_NAME = "muskit.lock.acquire";
    static final String FALLBACK_METRIC_NAME = "muskit.lock.fallback";
     ...
     */
    MicrometerLockObservation(MeterRegistry meterRegistry) {
